...
public class RentalGetterDTO {
    ...
    public RentalGetterDTO(long id, LocalDate startDate, LocalDate endDate, BigDecimal dailyCost,
                           boolean paid, VehicleRentalReturnerDTO vehicle, BuyerRentalReturnerDto buyer, List<User> sellers) {
